...
export const ads = pgTable(
  'ads',
  {
    ...
    marketMedianPrice: real('market_median_price'),
    marketPrice: real('market_price'),
    marginAmount: real('margin_amount'),
    marginPercentage: real('margin_percentage'),
  ...
  (table) => [
    ...
    index("ads_type_id_idx").on(table.typeId),
    ...
    index("ads_price_max_idx").on(table.priceMax),    
    index('ads_title_idx').on(table.title),
    index("ads_margin_amount_min").on(table.marginAmountMin),
    index("ads_margin_amount_max").on(table.marginAmountMax),
    index("ads_margin_percent_min").on(table.marginPercentageMin),
    index("ads_margin_percent_max").on(table.marginPercentageMax),
    index("ads_margin_percentage_idx").on(table.marginPercentage),
    index("ads_fuel_id_idx").on(table.fuelId),
